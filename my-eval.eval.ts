...
evalite("output judge", {
	...
	task: async (input) => {
      ...
      providerOptions,
			prompt: input,
			system:
				"You are a helpful assistant that can help with tasks and events. You have access to resolveDateTool to convert natural language date expressions into ISO date strings.",
			tools: {
